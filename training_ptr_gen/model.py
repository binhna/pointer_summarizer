...
def init_embedding_weight(wt, vectors):
    if vectors is not None:
        wt.data.copy_(vectors)
    else:
...
class Encoder(nn.Module):
    def __init__(self, args):
        ...
        init_embedding_weight(self.embedding.weight, args.vectors)
...
class Decoder(nn.Module):
    def __init__(self, args):
        ...
        self.out2 = nn.Linear(config.hidden_dim, args.vocab_size)
    ...
    def forward(self, y_t_1, s_t_1, encoder_outputs, encoder_feature, enc_padding_mask,
        ...
        if config.pointer_gen:
            ...
            final_dist = vocab_dist_.scatter_add(
